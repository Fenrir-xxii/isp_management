...
<nav class="navbar navbar-main navbar-expand-lg bg-transparent shadow-none position-absolute px-4 w-100 z-index-2">
    <div class="container-fluid py-5">
        <nav aria-label="breadcrumb">
            ...
            @if (Route::currentRouteName() == 'personal-cabinet')
                <h4 class="text-white font-weight-bolder ms-2 text-capitalize"> {{ __('site.nav.personal_cabinet') }}
                </h4>
            @else
                <h4 class="text-white font-weight-bolder ms-2 text-capitalize"> {{ __('site.nav.business_cabinet') }}
                </h4>
            @endif
        </nav>
        <div class="collapse navbar-collapse me-md-0 me-sm-4 mt-sm-0 mt-2" id="navbar">
            <div class="ms-md-auto pe-md-4 d-flex align-items-center">
                <select class="form-select language-change form-select-sm" id="language-change" aria-label="Language"
                    style="width:100px;">
