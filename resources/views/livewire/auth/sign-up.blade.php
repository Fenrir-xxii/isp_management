                      ...
                      <div class="card-body">
                          ...
                          <form wire:submit.prevent="register" action="#" method="POST" role="form text-left">
                            <div class="form-check form-check-info text-left">
                                <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" wire:model="is_corporate">
                            ...
                            <div class="mb-3">
                              ...
                              <div class="mb-3">
                                <div class="@error('username_connection') border border-danger rounded-3  @enderror">
                                    <input wire:model="username_connection" type="text" class="form-control" placeholder="Username Connection"
                                        aria-label="username_connection" aria-describedby="email-addon">
                                </div>
                                @error('username_connection') <div class="text-danger">{{ $message }}</div> @enderror
                            </div>
                              <div class="mb-3">
                              ...
                              <div class="form-check form-check-info text-left">
                                  <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"
                                      checked>
                                  <label class="form-check-label" for="flexCheckDefault">
                                      {{ __('I agree the') }} <a href="/terms-conditions"
