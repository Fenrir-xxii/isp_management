            ...
            <div class="card mb-4 mx-4">
                <div class="card-header pb-0">
                    <div class="d-flex flex-row justify-content-between">
                        ...
                        <a href="/create-client" class="btn bg-gradient-primary btn-sm mb-0" type="button">+&nbsp; New Client</a>
                    </div>
                </div>
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ $client->first_name . " " . $client->last_name }}</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ $client->username }}</p>
                                    </td>
                                    <td class="text-center">
                                        <p class="text-xs font-weight-bold mb-0">{{ $client->e_mail }}</p>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{ $client->phone }}</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{ $client->tariff->title }}</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{ $client->balance }}</span>
                                    </td>
                                    <td class="text-center">
                                        <span class="text-secondary text-xs font-weight-bold">{{ $client->status->title }}</span>
                                    </td>
                                    <td class="text-center">
                                        <a href="/edit-client/0{{ $client->id }}" class="mx-3" data-bs-toggle="tooltip"
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="/edit-client/1{{ $client->id }}" class="mx-3" data-bs-toggle="tooltip"
                                            data-bs-original-title="Edit client">
                                            <i class="fas fa-user-edit text-secondary"></i>
                                        </a>
                                        {{-- <span>
