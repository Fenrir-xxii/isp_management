                         ...
                         <div class="row">
                             <div class="col-8">
                                 <div class="numbers">
                                     ...
                                     <div class="my-2">
                                         Corpoprate:<p class="text-info text-sm font-weight-bolder my-0"> ₴
                                             {{ number_format($corporate_clients_income, 2) }}</p>
                                         Individual:<p class="text-success text-sm font-weight-bolder my-0"> ₴
                                             {{ number_format($individual_clients_income, 2) }}</p>
                                     </div>
                                 </div>
                             </div>
                 ...
                 <div class="card">
                     <div class="card-body p-3">
                         <div class="row">
                             <div class="col-8">
                                 <div class="numbers">
                                     <p class="text-sm mb-0 text-capitalize font-weight-bold">Additional Services
                                         Monthly Income
                                     </p>
                                     <h5 class="font-weight-bolder mb-0">
                                         ₴ {{ number_format($additional_options_income, 2) }}
                                     </h5>
                                     <div class="my-2">
                                         Corpoprate:<p class="text-info text-sm font-weight-bolder my-0"> ₴
                                             {{ number_format($corporate_additional_options_income, 2) }}</p>
                                         Individual:<p class="text-success text-sm font-weight-bolder my-0"> ₴
                                             {{ number_format($individual_additional_options_income, 2) }}</p>
                                     </div>
                                 </div>
                             </div>
                             <div class="col-4 text-end">
                         ...
                         <div class="row">
                             <div class="col-8">
                                 <div class="numbers">
                                     ...
                                     <div class="my-2">
                                         Corpoprate:<p class="text-info text-sm font-weight-bolder my-0">
                                             {{ $corporate_clients_count }} companies</p>
                                         Individual:<p class="text-success text-sm font-weight-bolder my-0">
                                             {{ $individual_clients_count }} persons</p>
                                     </div>
                                 </div>
                             </div>
                             <div class="col-4 text-end">
                         ...
                         <div class="row">
                             <div class="col-8">
                                 <div class="numbers">
                                     ...
                                     <h5 class="font-weight-bolder mb-0">
                                         {{ $new_clients_total_count }}
                                     </h5>
                                     <div class="my-2">
                                         Corpoprate:<p class="text-info text-sm font-weight-bolder my-0">
                                             {{ $new_corporate_clients_count }} companies</p>
                                         Individual:<p class="text-success text-sm font-weight-bolder my-0">
                                             {{ $new_individual_clients_count }} persons</p>
                                     </div>
                                 </div>
                             </div>
                             <div class="col-4 text-end">
             ...
             <div class="col-lg-5 mb-lg-0 mb-4">
                 <div class="card">
                     <div class="card-body p-3">
                         ...
                         <h6 class="ms-2 mt-4 mb-0"> Last six month income </h6>
             ...
             <div class="col-lg-5 col-md-6">
                 <div class="card h-100">
                     ...
                     <div class="card-body p-3">
                        ...
                        @foreach($last_five_received_payments as $payment)
                        <div class="timeline-block mb-3">
                            <span class="timeline-step">
                                <i class="ni ni-money-coins text-dark text-gradient"></i>
                            </span>
                            <div class="timeline-content">
                                <h6 class="text-dark text-sm font-weight-bold mb-0">{{$payment->amount}} ₴</h6>
                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">{{$payment->datetime}}</p>
                                @if(is_null($payment->individual_client))
                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">from {{$payment->corporate_client->name}}</p>
                                @else
                                <p class="text-secondary font-weight-bold text-xs mt-1 mb-0">from {{$payment->individual_client->first_name . ' ' . $payment->individual_client->last_name}}</p>
                                @endif
                            </div>
                        </div>
                        @endforeach
 ...
 <script>
     ...
     let dataArr = @json($last_six_month_income);
    //  console.log(dataArr);
     new Chart(ctx, {
         type: "bar",
         data: {
    ...
    let dataDonwload = @json($last_seven_days_donwloaded_traffic);
    let dataUpload = @json($last_seven_days_uploaded_traffic);
    let dataLabels = @json($last_seven_days_labels);
    //  console.log(dataDonwload);
     new Chart(ctx2, {
         type: "line",
         data: {
            //labels: ["01.12.23", "02.12.23", "03.12.23", "04.12.23", "05.12.23", "06.12.23", "07.12.23"],
            labels: dataLabels,
             datasets: [{
                     label: "Downloaded, Gb",
                     tension: 0.4,
